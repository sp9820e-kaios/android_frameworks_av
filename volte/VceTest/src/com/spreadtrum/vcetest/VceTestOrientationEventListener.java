...
import com.spreadtrum.vcetest.VceTestFragment;
 ...
 * of the change.
 */
public class VceTestOrientationEventListener extends OrientationEventListener {

    private static final String TAG = "VceTestOrientationEventListener";
    ...
    public VceTestOrientationEventListener(Context context) {
        super(context);
    }
    ...
    public void onOrientationChanged(int rotation) {
        ...
        if (orientation != SCREEN_ORIENTATION_UNKNOWN && sCurrentOrientation != orientation) {
            Log.i(TAG, "onOrientationChanged " + sCurrentOrientation + " -> " + orientation);
            sCurrentOrientation = orientation;
            VceTestFragment.setPreviewOrientation(sCurrentOrientation);
            //VideoCallEngine.getInstance().setPreviewDisplayOrientation(sCurrentOrientation);
        }
    }
